...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, q, k, v, mask=None):
        ...
        print('MultiHeadAttention k q v', k.size(), q.size(), v.size())
        ...
        print('MultiHeadAttention att scores...', scores.size())
...
class Generator(nn.Module):
    ...
    def __init__(self, input_features, hidden_features, final_features, num_heads, dropout, num_block, num_variable, seq_len):
...
class Discriminator(nn.Module):
    ...
    def __init__(self, input_features, hidden_features, final_features, num_heads, dropout, num_block, num_variable, seq_len):
        ...
        self.linear_tmp = nn.Linear(input_features, final_features)
    def forward(self, x, adj, c):
        ...
        new_x = []
        for i in range(self.seq_len):
            new_x.append(F.leaky_relu(self.bn1(self.linear_tmp(x[:, i, :, :])), 0.2))
