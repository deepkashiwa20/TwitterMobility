...
import struct
import argparse
from GAN_simpleD import Generator
from GAN_simpleD import Discriminator
...
START_DATE, END_DATE = '2019-09-01 00:00:00', '2019-10-31 23:00:00'
...
parser.add_argument("--epoch", type=int, default=100, help="number of epochs of training") # original 1500
